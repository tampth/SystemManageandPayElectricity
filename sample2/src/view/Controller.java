...
public class Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            User user = UserController.getInstance().findbylogin(HolderManager.getInstance().getUsername());
            txtFullName.setText(user.getFullname());
            txtCusID.setText(user.getId());
            txtPhone.setText(user.getPhone());
            txtGender.setText(user.getGender());
            txtBirthDay.setValue(LocalDate.parse(user.getBirthday().toString()));
            txtAddress.setText(user.getAddress());
            txtNationalID.setText(user.getNationalid());
            txtRegion.setText(user.getRegion());
